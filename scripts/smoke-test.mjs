...
try {
  ...
  expectExit('mission workflow still fails omitted uv.lock when dependency manifest changed', ['node', missionCli, 'activate', '--approved', '--plan-path', manifestLockPlanPath, '--cwd', manifestLockRepo], 1, { env: { PI_MISSION_WORKFLOW_PI_BIN: fakePiManifestLock }, timeout: 60_000 });
